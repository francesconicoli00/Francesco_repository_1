...
```{r, add_PC_img, fig.align='center', echo=FALSE}
...
```{r, add_milan_img, out.width="70%", fig.align='center', echo=FALSE}
...
```{r, add_LBS_img, out.width="70%", fig.align='center', echo=FALSE}
